...
pcall(function()if game.PlaceId == 155615604 then
    ...
    Title = "Notification";
    Text = "DRKscrips on top"; -- what the text says (ofc)
    Duration = 10;
  })
  ...
  game.StarterGui:SetCore("SendNotification", {
    Title = "Teleport Tool";
    Text = "Made by scripter"; -- what the text says (ofc)
    Duration = 5;
  })
  ...
  AdminSection:NewButton("DRK Admin (Made By Me)", "", function()
             print("Clicked")
  ...
  Notification.new("message", "YouTube : DRKscripts", "YouTube - DRKscripts")
  else
  ...
  AdminSection:NewButton("DRK Prison Gui", "", function()
        print("Clicked")
  ...
  AdminSection:NewButton("DRK Prison Life Gui", "", function()
        print("Clicked")
  ...
  game.Workspace.Remote.ItemHandler:InvokeServer({Position = game.Players.LocalPlayer.Character.Head.Position, Parent = game.Workspace.Prison_ITEMS.hats["Police hat"]})    
    ...
    GunsSection:NewButton("Get DRK helmet", "", function()
        print("Clicked")
  ...
  Credits.Text = "Made by DRKscripts"
